...
void MX_SPI1_Init(void)
{
  ...
  // PLL1Q changed 42.67→120 MHz.  120/16 = 7.5 MHz exceeds ADS8325 max SCLK (~4.8 MHz @ 3.3 V).
  // Override to /32 → 3.75 MHz (≈ original 2.67 MHz).
...
void MX_SPI2_Init(void)
{
  ...
  // PLL1Q changed 50→120 MHz.  120/4 = 30 MHz exceeds GPIO_SPEED_FREQ_LOW.
  // Override to /8 → 15 MHz (≈ original 12.5 MHz).
